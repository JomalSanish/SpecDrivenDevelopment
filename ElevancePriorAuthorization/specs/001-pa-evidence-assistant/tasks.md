...
- [ ] T008 [US1] Create `Policy` and `PolicyRequirement` models in `backend/src/models/policy.py`
...
- [ ] T011 [US2] Create `Case` and `Document` models in `backend/src/models/case.py`
...
- [ ] T023 [US3] Implement strict locking endpoint `POST /api/v1/review/cases/{case_id}/claim` (`backend/src/api/review_routes.py`)
- [ ] T024 [US3] Implement Nurse decision endpoint `POST /api/v1/review/cases/{case_id}/decision` ensuring structured reason codes (`backend/src/api/review_routes.py`)
...
- [ ] T031 [US4] Implement SLA escalation timer to re-route cases after timeout (`backend/src/services/sla_service.py`)
